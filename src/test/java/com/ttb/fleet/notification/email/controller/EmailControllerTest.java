...
class EmailControllerTest {
    ...
    private void init() {
        ...
        try {
            lenient().when(emailservice.send(Mockito.anyString(), new String[]{Mockito.anyString()}, Mockito.anyString(),Mockito.anyString(), Mockito.anyMap(), Mockito.anyMap(), Mockito.anyString())).thenReturn(emailout);
